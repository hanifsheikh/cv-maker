    ...
    <main>
        <div class="container">
            <div class="d-flex justify-content-center">
                <div class="card my-5 border-0 rounded-3 shadow-sm p-3" style="width: 35rem">
                    <form class="flex flex-row w-100 p-3" action="<?php echo url('/auth/register'); ?>" method="POST">
                        <div class="flex my-3">
                            <a href="<?php echo APP_URL; ?>">
                                <img src="<?php echo LOGO; ?>" alt="logo" class="w-25 align-center object-fit-cover rounded-3">
                            </a>
                        </div>
                        <h3 class="fs-3 fw-semibold">Sign Up</h3>
                        <p class="fs-5 fw-regular">Create a new account.</p>
                        <div class="flex w-100 mb-3">
                            <p class="text-start fs-6 fw-semibold mb-1">Name</p>
                            <input name="name" type="text" class="flex form-control" required />
                        </div>
                        <div class="flex w-100 mb-3">
                    ...
                    <p class="text-muted fs-6">Already have an account? <a class="fw-semibold" href="<?php echo url('/auth/login'); ?>"> Login </a></p>
                </div>
            </div>
        </div>
    </main>

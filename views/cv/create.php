<div class="container">
    <form action="<?php echo url('/cv/store'); ?>" method="POST">
        <?php if (count($template_options)) : ?>
            <div class="card border-0 rounded-3 shadow-sm p-3" x-data="{ skills: [], educations: [], experiences:[], references:[], languages:[], hobbies:[], social_links:[], awards:[], activities:[], with_percentage:   <?php echo ($template_options['skill']['no_percentage'] == 1 && $template_options['skill']['percentage'] == 1) ? 1 : (($template_options['skill']['no_percentage'] == 1 && $template_options['skill']['percentage'] == 0) ? 0 : 1); ?>, name_size:33}">
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="name" type="text" class="form-control" placeholder="Your Full Name" aria-label="name" aria-describedby="name" required>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="headline" type="text" class="form-control" placeholder="" aria-label="headline" aria-describedby="headline" required>
                                    </div>
                                </div>
                                <?php if (isset($template_options['about'])) : ?>
                                    <div class="col-md-12">
                                        <div class="flex w-100 mb-2">
                                            ...
                                            <textarea name="about" rows="3" name="about" class="form-control"></textarea>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <?php if (isset($template_options['career_objective'])) : ?>
                                    <div class="col-md-12">
                                        <div class="flex w-100 mb-2">
                                            ...
                                            <textarea name="objectives" rows="3" name="objectives" class="form-control" required></textarea>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <div class="d-inline-block text-center">
                                <a href="<?php echo url('/cv/templates'); ?>" class="fw-bold d-block text-decoration-none mb-2">
                                    <i style="height:18px;" data-feather="edit"></i>
                                    Change Template
                                </a>
                                <div class="d-inline-block p-2 rounded-3 bg-white border shadow-sm border-primary" href="<?php echo url('/cv/template'); ?>">
                                    <img src="<?php echo asset('/images/templates/template_' . $data['template_id'] . '.webp'); ?>" alt="<?php echo 'template_' . $data['template_id']; ?>" style="width:128px;">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="email" type="email" class="form-control" placeholder="Your Email Address" aria-label="email" aria-describedby="email" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="mobile">Mobile</span>
                                        <input name="mobile" type="text" class="form-control" placeholder="Mobile Number" aria-label="mobile" aria-describedby="mobile" required>
                                    </div>
                                </div>
                                <?php if (isset($template_options['website'])) : ?>
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <input name="website" type="text" class="form-control" placeholder="Website url" aria-label="website" aria-describedby="website">
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <div class="col-md-12">
